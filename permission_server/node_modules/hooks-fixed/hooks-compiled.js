...
module.exports = {
   ...
   */
  hook: function hook(name, fn, errorCb) {
    ...
    proto[name] = function () {
      ...
      lastArg = arguments[arguments.length - 1],
          ...
          _asyncsDone = function _asyncsDone(err) {
        if (err) {
  ...
  pre: function pre(name, isAsync, fn, errorCb) {
  ...
  post: function post(name, isAsync, fn) {
  ...
  removePre: function removePre(name, fnToRemove) {
    var proto = this.prototype || this,
        pres = proto._pres || (proto._pres || {});
  ...
  _lazySetupHooks: function _lazySetupHooks(proto, methodName, errorCb) {
...
//# sourceMappingURL=hooks-compiled.js.map