...
module.exports = {
   ...
   */
  hook: function hook(name, fn, err) {
    ...
    proto[name] = function () {
      var self = this,
        ...
        var wrapper = function wrapper() {
          ...
          if (numAsyncPres) {
            ...
            if (arguments.length) hookArgs = [].slice.call(arguments, 2);
            pre.apply(self, [preChain[i + 1] || allPresInvoked, asyncComplete].concat(hookArgs));
          } else {
            if (arguments.length) hookArgs = [].slice.call(arguments);
            pre.apply(self, [preChain[i + 1] || allPresDone].concat(hookArgs));
          }
        }; // end wrapper = function () {...
        if (wrapper.isAsync = pre.isAsync) numAsyncPres++;
        return wrapper;
      }); // end posts.map(...)
      function allPresInvoked() {
        if (arguments[0] instanceof Error) err(arguments[0]);
      }
      ...
      if (numAsyncPres) {
        var _asyncComplete = function _asyncComplete() {
          if (arguments[0] instanceof Error) return err(arguments[0]);
  ...
  pre: function pre(name, fn, isAsync) {
  ...
  post: function post(name, fn, isAsync) {
    var proto = this.prototype,
        posts = proto._posts = proto._posts || {};
...
//# sourceMappingURL=hooks.alt-compiled.js.map