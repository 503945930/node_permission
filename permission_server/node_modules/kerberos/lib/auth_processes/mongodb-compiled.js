...
var MongoAuthProcess = function MongoAuthProcess(host, port, service_name) {
 ...
 *
 *******************************************************************/
var Win32MongoProcessor = function Win32MongoProcessor(host, port, service_name) {
  this.host = host;
  this.port = port;
  // SSIP classes
 ...
 *
 *******************************************************************/
var UnixMongoProcessor = function UnixMongoProcessor(host, port, service_name) {
  this.host = host;
  this.port = port;
  // SSIP classes
