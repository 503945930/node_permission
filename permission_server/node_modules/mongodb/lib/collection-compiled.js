...
Collection.prototype.find = function () {
  ...
  // Sort options
  if (findCommand.sort) findCommand.sort = formattedOrderClause(findCommand.sort);
...
Collection.prototype.findOneAndDelete = function (filter, options, callback) {
  if (typeof options == 'function') callback = options, options = {};
  this.findAndModify(filter, options.sort, null, {
...
Collection.prototype.findOneAndReplace = function (filter, replacement, options, callback) {
  if (typeof options == 'function') callback = options, options = {};
  this.findAndModify(filter, options.sort, replacement, {
    fields: options.projection,
    update: true,
...
Collection.prototype.findOneAndUpdate = function (filter, update, options, callback) {
  if (typeof options == 'function') callback = options, options = {};
  this.findAndModify(filter, options.sort, update, {
    fields: options.projection,
    update: true,
    'new': typeof options.returnOriginal == 'boolean' ? !options.returnOriginal : false,
    upsert: typeof options.upsert == 'boolean' ? options.upsert : false
...
Collection.prototype.findAndModify = function (query, sort, doc, options, callback) {
  ...
  // Execute the command
  this.s.db.command(queryObject, options, function (err, result) {
    if (err) return handleCallback(callback, err, null);
...
var getReadPreference = function getReadPreference(self, options, db, coll) {
  var r = null;
