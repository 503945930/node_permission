...
MongoClient.connect = function (url, options, callback) {
  ...
  if (replSetServersOptions.ssl || replSetServersOptions.sslValidate || replSetServersOptions.sslCA || replSetServersOptions.sslCert || replSetServersOptions.sslKey || replSetServersOptions.sslPass) {
  ...
  if (mongosOptions.ssl || mongosOptions.sslValidate || mongosOptions.sslCA || mongosOptions.sslCert || mongosOptions.sslKey || mongosOptions.sslPass) {
  ...
  for (var i = 0; i < object.servers.length; i++) {
    ...
    var connectFunction = function connectFunction(__server) {
      // Attempt connect
      new Db(object.dbName, __server, { w: 1, native_parser: false }).open(function (err, db) {
        ...
        if (totalNumberOfServers == 0) {
          ...
          if (totalNumberOfMongodServers == 0 && totalNumberOfMongosServers == 0 && object.servers.length == 1) {
...
var _setNativeParser = function _setNativeParser(db_options) {
...
var _finishConnecting = function _finishConnecting(serverConfig, object, options, callback) {
