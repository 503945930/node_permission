...
GridStore.prototype.close = function (callback) {
  ...
  if (self.mode[0] == "w") {
    ...
    if (typeof callback == 'function') callback(new MongoError(f("Illegal mode %s", self.mode), null));
  }
};
...
var _getWriteConcern = function _getWriteConcern(self, options) {
  ...
  if (finalOptions.w < 1 && (finalOptions.journal == true || finalOptions.j == true || finalOptions.fsync == true)) throw new MongoError("No acknowledgement using w < 1 cannot be combined with journal:true or fsync:true");
