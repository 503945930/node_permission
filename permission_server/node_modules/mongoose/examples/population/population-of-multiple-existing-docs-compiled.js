  ...
  Game.find({}).exec(function (err, games) {
    ...
    Game.populate(games, options, function (err, games) {
      ...
      games.forEach(function (game) {
        console.log('"%s" was released for the %s on %s', game.name, game.consoles[0].name, game.released.toLocaleDateString());
      });
...
//# sourceMappingURL=population-of-multiple-existing-docs-compiled.js.map