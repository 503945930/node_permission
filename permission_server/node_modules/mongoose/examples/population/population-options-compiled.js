...
function example() {
  Game.find({}).populate({
    ...
    games.forEach(function (game) {
      console.log('"%s" was released for the %s on %s', game.name, game.consoles.length ? game.consoles[0].name : '??', game.released.toLocaleDateString());
    });
...
//# sourceMappingURL=population-options-compiled.js.map