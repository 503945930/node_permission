...
Connection.prototype._open = function (callback) {
  ...
  var method = this.replica ? 'doOpenSet' : 'doOpen';
...
Connection.prototype.onOpen = function (callback) {
  ...
  function open(err, isAuth) {
    ...
    for (var i in self.collections) self.collections[i].onOpen();
...
Connection.prototype.onClose = function () {
  ...
  // avoid having the collection subscribe to our event emitter
  // to prevent 0.3 warning
  for (var i in this.collections) this.collections[i].onClose();
...
Connection.prototype.collection = function (name, options) {
  if (!(name in this.collections)) this.collections[name] = new Collection(name, this, options);
