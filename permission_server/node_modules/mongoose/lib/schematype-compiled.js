...
SchemaType.prototype.set = function (fn) {
  if ('function' != typeof fn) throw new TypeError('A setter must be a function.');
...
SchemaType.prototype.get = function (fn) {
  if ('function' != typeof fn) throw new TypeError('A getter must be a function.');
...
SchemaType.prototype.required = function (required, message) {
  ...
  this.requiredValidator = function (v) {
    ...
    return 'function' === typeof required && !required.apply(this) || self.checkRequired(v, this);
  };
...
//# sourceMappingURL=schematype-compiled.js.map