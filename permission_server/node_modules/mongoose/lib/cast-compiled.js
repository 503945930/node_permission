    ...
    if ('$or' === path || '$nor' === path || '$and' === path) {
      ...
      if (!schematype) {
        ...
        if (utils.isObject(val)) {
          ...
          var geo = val.$near ? '$near' : val.$nearSphere ? '$nearSphere' : val.$within ? '$within' : val.$geoIntersects ? '$geoIntersects' : '';
          ...
          if ('$within' == geo) {
            ...
            value = withinType;
          } else if ('$near' == geo && 'string' == typeof value.type && Array.isArray(value.coordinates)) {
            // geojson; cast the coordinates
            value = value.coordinates;
          } else if (('$near' == geo || '$nearSphere' == geo || '$geoIntersects' == geo) && value.$geometry && 'string' == typeof value.$geometry.type && Array.isArray(value.$geometry.coordinates)) {
            // geojson; cast the coordinates
...
//# sourceMappingURL=cast-compiled.js.map