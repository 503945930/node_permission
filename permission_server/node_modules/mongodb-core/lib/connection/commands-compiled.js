...
Query.prototype.toBin = function () {
  var self = this;
  // Basic length
  var length = 4 + Buffer.byteLength(self.ns) + 1 + 4 + 4 + self.bson.calculateObjectSize(self.query, self.serializeFunctions, true) + 4 * 4;
  ...
  // Serialize query
  var queryLength = this.bson.serializeWithBufferAndIndex(this.query, this.checkKeys, _buffer, index, this.serializeFunctions) - index + 1;
  ...
  if (this.returnFieldSelector && Object.keys(this.returnFieldSelector).length > 0) {
    var fieldSelectorLength = this.bson.serializeWithBufferAndIndex(this.returnFieldSelector, this.checkKeys, _buffer, index, this.serializeFunctions) - index + 1;
