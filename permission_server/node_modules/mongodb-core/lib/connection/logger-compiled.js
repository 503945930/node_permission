...
Logger.prototype.debug = function (message, object) {
  if (this.isDebug() && classFilters[this.className] && (filteredClasses[this.className] || Object.keys(filteredClasses).length == 0)) {
...
Logger.prototype.info = function (message, object) {
  if (this.isInfo() && classFilters[this.className] && (filteredClasses[this.className] || Object.keys(filteredClasses).length == 0)) {
    var dateTime = new Date().getTime();
...
Logger.prototype.error = function (message, object) {
  if (this.isError() && classFilters[this.className] && (filteredClasses[this.className] || Object.keys(filteredClasses).length == 0)) {
    var dateTime = new Date().getTime();
