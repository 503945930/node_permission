...
var pickServer = function pickServer(self, s, readPreference) {
  ...
  if (readPreference.equals(ReadPreference.secondary) && s.replState.secondaries.length == 0) throw new MongoError("no secondary server available");

  if (readPreference.equals(ReadPreference.secondaryPreferred) && s.replState.secondaries.length == 0 && s.replState.primary == null) throw new MongoError("no secondary or primary server available");
...
var connectToServer = function connectToServer(self, state, host, port) {
