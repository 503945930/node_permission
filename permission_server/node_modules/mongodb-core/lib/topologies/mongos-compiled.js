...
var State = function State(readPreferenceStrategies) {
  // Internal state
  this.s = {
    connectedServers: [],
    disconnectedServers: [],
...
//
var mongosInquirer = function mongosInquirer(self, state) {
  return function () {
...
var errorHandlerTemp = function errorHandlerTemp(self, state, server) {
...
// Connect handler
var connectHandler = function connectHandler(self, state, e) {
  return function (server) {
    ...
    var processNewServer = function processNewServer(_server) {
...
var addCredentials = function addCredentials(state, db, argsWithoutCallback) {
...
var clearCredentials = function clearCredentials(state, ns) {
  var db = ns.split('.')[0];
...
var processReadPreference = function processReadPreference(cmd, options) {
  options = options || {};
...
var executeWriteOperation = function executeWriteOperation(state, op, ns, ops, options, callback) {
