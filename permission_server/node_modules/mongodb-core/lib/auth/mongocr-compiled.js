...
MongoCR.prototype.auth = function (server, pool, db, username, password, callback) {
  ...
  while (connections.length > 0) {
    ...
    var executeMongoCR = function executeMongoCR(connection) {
      ...
      server.command(f("%s.$cmd", db), { getnonce: 1 }, { connection: connection }, function (err, r) {
        var nonce = null;
        var key = null;
        ...
        // Execute command
        server.command(f("%s.$cmd", db), { authenticate: 1, user: username, nonce: nonce, key: key }, { connection: connection }, function (err, r) {
          count = count - 1;
...
//# sourceMappingURL=mongocr-compiled.js.map