...
var serializeString = function serializeString(key, value, index) {
  // Encode String type
...
var serializeNumber = function serializeNumber(key, value, index) {
...
var serializeUndefined = function serializeUndefined(key, value, index) {
  // Set long type
...
var serializeBoolean = function serializeBoolean(key, value, index) {
  // Write the type
...
var serializeDate = function serializeDate(key, value, index) {
  // Write the type
...
var serializeRegExp = function serializeRegExp(key, value, index) {
  // Write the type
...
var serializeMinMax = function serializeMinMax(key, value, index) {
...
var serializeObjectId = function serializeObjectId(key, value, index) {
  // Write the type
...
var serializeBuffer = function serializeBuffer(key, value, index) {
  // Write the type
...
var serializeObject = function serializeObject(key, value, index, checkKeys, depth) {
  // Write the type
...
var serializeLong = function serializeLong(key, value, index) {
  // Write the type
...
var serializeDouble = function serializeDouble(key, value, index) {
  // Encode as double
  buffer[index++] = BSON.BSON_DATA_NUMBER;
  // Number of written bytes
  var numberOfWrittenBytes = buffer.write(key, index, 'utf8');
...
var serializeCode = function serializeCode(key, value, index, checkKeys, depth) {
...
var serializeBinary = function serializeBinary(key, value, index) {
  // Write the type
  buffer[index++] = BSON.BSON_DATA_BINARY;
  // Number of written bytes
  var numberOfWrittenBytes = buffer.write(key, index, 'utf8');
...
var serializeSymbol = function serializeSymbol(key, value, index) {
  // Write the type
...
var serializeDBRef = function serializeDBRef(key, value, index, depth) {
  // Write the type
