 ...
 * @api private
 */
var serializeObject = function serializeObject(object, checkKeys, buffer, index, serializeFunctions) {
  if (object.toBSON) {
...
var numberOfBytes = function numberOfBytes(str) {
  var ch,
      st,
      re = 0;
  for (var i = 0; i < str.length; i++) {
 ...
 * @api private
 */
var writeToTypedArray = function writeToTypedArray(buffer, string, index) {
 ...
 * @api private
 */
var packElement = function packElement(name, value, checkKeys, buffer, index, serializeFunctions) {
 ...
 * @api private
 */
var crc32 = function crc32(string, start, end) {
  var crc = 0;
  var x = 0;
  var y = 0;
  crc = crc ^ -1;
 ...
 * @api private
 */
var convertUint8ArrayToUtf8String = function convertUint8ArrayToUtf8String(byteArray, startIndex, endIndex) {
...
BSON.deserialize = function (buffer, options, isArray) {
  ...
  var readCStyleString = function readCStyleString() {
