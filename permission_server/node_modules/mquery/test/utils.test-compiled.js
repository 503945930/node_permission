...
describe('lib/utils', function () {
  describe('clone', function () {
    ...
    it('clones mongodb.ReadPreferences', function (done) {
      ...
      var tags = [{ dc: 'tag1' }];
      var prefs = [new mongo.ReadPreference("primary"), new mongo.ReadPreference(mongo.ReadPreference.PRIMARY_PREFERRED), new mongo.ReadPreference("primary", tags), mongo.ReadPreference("primary", tags)];
